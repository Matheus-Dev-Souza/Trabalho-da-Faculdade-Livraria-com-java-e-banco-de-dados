...
public class ViewVenda {
	...
	private void initialize() {
		...
		table = new JTable();
		table.setModel(VendaControlador.updateTable());
		...
		btnAddItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(VendaControlador.addItem(textCodigo.getText(), textQtd.getText())) {
					table.setModel(VendaControlador.updateTable());
					lblValor.setText("" + VendaControlador.getPedidoAberto().getPrecoTotal());
				}
		...
		btnAddItem.setBounds(358, 34, 200, 46);
		frame.getContentPane().add(btnAddItem);
		
		JLabel lblTotal = new JLabel("Total:");
		lblTotal.setHorizontalAlignment(SwingConstants.LEFT);
		lblTotal.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblTotal.setBounds(10, 704, 60, 46);
		...
		lblValor.setBounds(80, 704, 80, 46);
		...
		lblMoeda.setBounds(170, 704, 60, 46);
